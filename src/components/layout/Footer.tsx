...
const Footer = () => {
  return (
    <>
      <footer className="bg-red-600 p-4 z-50">
        <Wrapper>
              ...
              >
                <div className="p-2 mr-4 my-4 rounded-full bg-white hover:scale-105 duration-200">
                  <svg
                    ...
                    stroke-width="0"
                    viewBox="0 0 320 512"
                    className="text-red-600 h-4 md:h-6 w-4 md:w-6"
                    height="1em"
                    width="1em"
              ...
              >
                <div className="p-2 mr-4 my-4 rounded-full bg-white hover:scale-105 duration-200">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-instagram text-red-600 h-4 md:h-6 w-4 md:w-6"
                    viewBox="0 0 16 16"
                  >
                    {" "}
              ...
              <a target="_blank" href="https://www.linkedin.com/in/saad-butt-29853524a">
                <div className="p-2 mr-4 my-4 rounded-full bg-white hover:scale-105 duration-200">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-linkedin text-red-600 h-4 md:h-6 w-4 md:w-6"
                    viewBox="0 0 16 16"
                  >
                    {" "}
