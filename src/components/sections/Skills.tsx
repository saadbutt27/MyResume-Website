          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="w-[100%] lg:w-[50%] flex flex-col items-center my-0 mx-[40px] lg:block lg:my-auto">
              ...
              <div className="mb-4 w-full px-4">
                ...
                <div
                  className={`h-1 w-full bg-slate-400 relative before:content-[''] before:absolute before:h-full before:w-[90%] before:left-0 before:top-0 before:bg-red-600`}
                ></div>
              </div>
